...
from backend.monitoring.prompts_monitor import PromptsMonitor, MonitoringConfig, DashboardMetrics
...
class TestPromptsMonitor:
    ...
    def monitor(self):
        ...
        config = MonitoringConfig(
            log_db_path="data/prompt_logs.db",
