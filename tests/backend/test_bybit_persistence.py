...
def test_persist_idempotent():
    ...
    rows = [
        {'open_time': now_ms, 'open': 1.0, 'high': 2.0, 'low': 0.9, 'close': 1.5, 'volume': 10, 'turnover': 15, 'raw': ['1600000000000','1','2','0.9','1.5','10','15']},
        {'open_time': now_ms, 'open': 1.0, 'high': 2.0, 'low': 0.9, 'close': 1.5, 'volume': 10, 'turnover': 15, 'raw': ['1600000000000','1','2','0.9','1.5','10','15']},
        {'open_time': now_ms + 60000, 'open': 1.5, 'high': 2.5, 'low': 1.4, 'close': 2.0, 'volume': 5, 'turnover': 10, 'raw': ['1600000060000','1.5','2.5','1.4','2.0','5','10']},
    ]
