...
class TestTournamentSelection:
    ...
    def test_tournament_select(self):
        ...
        individuals = [
            Individual(chromosome=Chromosome(genes={'p': i}), fitness=i)
            for i in range(1, 11)
        ]
...
class TestRouletteSelection:
    ...
    def test_roulette_select(self):
        ...
        individuals = [
            Individual(chromosome=Chromosome(genes={'p': i}), fitness=i * 10)
            for i in range(1, 6)
        ]
        pop = Population(individuals=individuals)
...
class TestSinglePointCrossover:
    ...
    def test_single_point_crossover(self):
        ...
        parent1 = Individual(
            chromosome=Chromosome(genes={'p1': 1.0, 'p2': 2.0, 'p3': 3.0})
        )
        parent2 = Individual(
            chromosome=Chromosome(genes={'p1': 4.0, 'p2': 5.0, 'p3': 6.0})
        )
        ...
        assert child1.chromosome.genes != parent1.chromosome.genes or \
               child1.chromosome.genes != parent2.chromosome.genes
...
class TestArithmeticCrossover:
    ...
    def test_arithmetic_crossover(self):
        ...
        parent1 = Individual(
            chromosome=Chromosome(genes={'p1': 1.0, 'p2': 2.0})
        )
        parent2 = Individual(
            chromosome=Chromosome(genes={'p1': 3.0, 'p2': 4.0})
        )
...
class TestGaussianMutation:
    ...
    def test_gaussian_mutation(self):
        ...
        assert mutant.chromosome.genes != individual.chromosome.genes or \
               abs(mutant.chromosome.genes['p1'] - 1.0) < 0.3
...
class TestUniformMutation:
    ...
    def test_uniform_mutation(self):
        ...
        individual = Individual(
            chromosome=Chromosome(genes={'p1': 5.0, 'p2': 5.0}, param_ranges=param_ranges)
        )
