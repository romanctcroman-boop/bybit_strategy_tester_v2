...
class TestRLIntegration:
    ...
    async def test_reward_shaping():
        ...
        from backend.agents.local_ml.rl_integration import RLAgentIntegration, MarketRegime
...
class TestIntegration:
    ...
    async def test_memory_with_metrics():
        ...
        from backend.agents.monitoring.metrics_collector import MetricsCollector, Metric, MetricType
