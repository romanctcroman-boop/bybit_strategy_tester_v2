"""
Manual test script для Strategy Tournament System (no emoji)
"""
...
async def test_basic_tournament():
    ...
    print(f"\n[OK] Tournament completed: {result.tournament_name}")
...
async def test_custom_weights():
    ...
    print(f"\n[WINNER] Winner with custom weights: {result.winner_name}")
