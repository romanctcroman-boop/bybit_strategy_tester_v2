...
if metrics:
    ...
    print(f"\nTV Reference:")
    print(f"  Total trades:    151")
    print(f"  Net profit:      $1091.53 (10.92%)")
    print(f"  Win rate:        90.73%")
    print(f"  Gross profit:    $2960.36")
    print(f"  Gross loss:      $1868.84")
    print(f"  Commission:      $211.47")
    print(f"  Profit factor:   1.584")
    print(f"  Sharpe ratio:    0.357")
    print(f"  Max drawdown:    6.00%")
else:
