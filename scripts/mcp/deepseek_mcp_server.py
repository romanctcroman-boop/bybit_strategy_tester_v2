    ...
    def _call_deepseek_api(
        ...
        try:
            ...
            req = urllib.request.Request(
                f"{DEEPSEEK_BASE_URL}/chat/completions", data=data, headers=headers, method="POST"
            )
            ...
            if e.code == 429:
                return {"error": "Rate limited. Please wait and try again.", "success": False, "status_code": 429}
            else:
                return {"error": f"API error: {e.code} - {e.reason}", "success": False, "status_code": e.code}
                    ...
                    "tools": [
                        {
                            ...
                            "inputSchema": {
                                ...
                                "properties": {
                                    ...
                                    "temperature": {
                                        "type": "number",
                                        "description": "Creativity (0.0-2.0)",
                                        "default": 0.7,
                                    },
                                },
                                "required": ["message"],
                        ...
                        },
                        {
                            ...
                            "inputSchema": {
                                ...
                                "properties": {
                                    ...
                                    "focus": {
                                        "type": "string",
                                        "description": "Analysis focus: performance, security, readability, all",
                                        "default": "all",
                                    },
                        ...
                        },
                        {
                            ...
                            "inputSchema": {
                                ...
                                "properties": {
                                    ...
                                    "goal": {
                                        "type": "string",
                                        "description": "Refactoring goal: simplify, optimize, modernize, dry",
                                    },
                                    "language": {"type": "string", "description": "Programming language"},
                                    "preserve_interface": {
                                        "type": "boolean",
                                        "description": "Keep the same public API",
                                        "default": True,
                                    },
                                },
                                "required": ["code"],
                        ...
                        },
                        {
                            ...
                            "inputSchema": {
                                ...
                                "properties": {
                                    ...
                                    "coverage": {
                                        "type": "string",
                                        "description": "Coverage level: basic, comprehensive, edge_cases",
