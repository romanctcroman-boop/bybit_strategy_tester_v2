...
DEFAULT_PARAM_RANGES: dict[str, dict[str, dict[str, Any]]] = {
    ...
    "stochastic": {
        "k_period": {"type": "int", "low": 5, "high": 21, "step": 1, "default": 14},
        "d_period": {"type": "int", "low": 2, "high": 5, "step": 1, "default": 3},
        "overbought": {"type": "int", "low": 70, "high": 90, "step": 5, "default": 80},
        "oversold": {"type": "int", "low": 10, "high": 30, "step": 5, "default": 20},
    },
    "cci": {
        "period": {"type": "int", "low": 10, "high": 30, "step": 1, "default": 20},
    },
