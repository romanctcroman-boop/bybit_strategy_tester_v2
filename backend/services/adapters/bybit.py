...
class BybitAdapter:
        ...
        for chosen_symbol in candidates:
            try:
                ...
                if data:
                    ...
                    try:
                        self._persist_klines_to_db(chosen_symbol, normalized, interval=interval_norm)
    ...
    def _persist_klines_to_db(
        ...
        Behaviour: best-effort; uses UNIQUE(symbol, interval, open_time) to avoid duplicates.
        
        Args:
            symbol: Trading pair symbol (e.g. 'BTCUSDT')
            normalized_rows: List of normalized kline dictionaries
            interval: Timeframe interval (e.g. '5', '15', '30', '60', 'D')
            ...
            if dialect in ("postgres", "postgresql"):
                sql = text(
                    ...
                    INSERT INTO bybit_kline_audit
                        (symbol, interval, open_time, open_time_dt, open_price, high_price, low_price, close_price, volume, turnover, raw)
                    VALUES
                        (:symbol, :interval, :open_time, :open_time_dt, :open_price, :high_price, :low_price, :close_price, :volume, :turnover, :raw)
                ...
                for p in params:
                    existing = (
                        ...
                        .filter(
                            ...
                            BybitKlineAudit.interval == p["interval"],
