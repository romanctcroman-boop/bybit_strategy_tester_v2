...
async def fetch_mtf(
    ...
    base: str = Query(None, description="Optional base timeframe to align from; defaults to smallest interval"),
    aligned: int = Query(1, description="If 1, return aligned data resampled from base; if 0, return raw working sets"),
