...
class L2OrderBookCollector:
    ...
    def __init__(
        ...
        # Order book state
        self.current_snapshot: L2Snapshot | None = None
    ...
    def _parse_snapshot(self, data: dict[str, Any]) -> L2Snapshot | None:
        ...
        try:
            ...
            return L2Snapshot(symbol=self.symbol, bids=bids, asks=asks, timestamp=datetime.now())
    ...
    def get_current_snapshot(self) -> L2Snapshot | None:
