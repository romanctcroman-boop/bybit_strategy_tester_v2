...
// Block Library Data
        ...
        async function saveStrategy() {
            const strategy = {
                ...
                marketType: document.getElementById('strategyMarketType').value,  // 'spot' or 'linear'
        ...
        async function runBacktest() {
            const name = document.getElementById('strategyName').value;
            const marketType = document.getElementById('strategyMarketType').value;
            const marketLabel = marketType === 'spot' ? '📊 SPOT (TradingView Parity)' : '📈 Futures (LINEAR)';
...
// Exported functions: renderBlockLibrary, renderTemplates, setupEventListeners, toggleCategory, filterBlocks
