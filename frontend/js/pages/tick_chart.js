...
const API_BASE = '/api/v1/marketdata/ticks';
        ...
        let candleIndex = 0;
        let indexToTimeMap = new Map(); // Map index -> real timestamp for tooltip
        ...
        // ETA calculation
        let recentTradesPerSecond = [];  // Rolling window of trades/sec
        const ETA_WINDOW_SIZE = 10;      // Average over 10 seconds
        let candlesCreatedInLastMinute = 0;
